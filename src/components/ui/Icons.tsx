...
export const DevpostIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg
    className={className}
    fill="currentColor"
    viewBox="0 0 24 24"
    aria-hidden="true"
  >
    <path d="M6.002 1.61L0 12.004 6.002 22.39h11.996L24 12.004 17.998 1.61H6.002zm1.593 4.083h4.705c3.567 0 6.037 2.115 6.037 6.31 0 4.197-2.47 6.31-6.037 6.31H7.595V5.693zm3.766 9.873c1.782 0 2.87-1.12 2.87-3.563 0-2.443-1.088-3.563-2.87-3.563h-1.077v7.126h1.077z" />
  </svg>
);
